<?php /*a:1:{s:58:"C:\wamp64\www\echo\application\index\view\index\index.html";i:1632203122;}*/ ?>
<!doctype html>
    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
					...
					<div class="row header_promo">
						...
						<div class="col-md-3  col-sm-3 col-xs-6">
							<div class="single_promo hvr-sweep-to-bottom">
								...
								<h2>数据结构与算法</h2><a href="#">Read More</a>
							</div>
						</div>
						<div class="col-md-3 col-sm-3 col-xs-6">
							<div class="single_promo hvr-sweep-to-bottom">
            ...
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('/static/img/slider/slide1.jpg');"></div>
				<div class="carousel-caption overlay">
                </div>
            </div>
            <div class="item">
                <!-- Set the second background image using inline CSS below. -->
                <div class="fill" style="background-image:url('/static/img/slider/slide2.jpg');"></div>
				<div class="carousel-caption overlay">
                </div>
            </div>
            <div class="item">
                <!-- Set the third background image using inline CSS below. -->
                <div class="fill" style="background-image:url('/static/img/slider/slide3.jpg');"></div>
				<div class="carousel-caption overlay">
                </div>
            </div>
        </div>
		...
		<div class="row hireme_row">
			...
			<div class="col-md-6 col-sm-6 col-xs-12 hireme_slider  wow slideInRight">
				<div id="hireme_slide" class="owl-carousel owl-theme">
				  <div class="item"><img src="/static/img/slider/hire_slide1.jpg" alt="The Last of us"></div>
				  <div class="item"><img src="/static/img/slider/hire_slide2.jpg" alt="GTA V"></div>
				  <div class="item"><img src="/static/img/slider/hire_slide3.jpg" alt="Mirror Edge"></div>
				</div>
			</div>
		</div>
