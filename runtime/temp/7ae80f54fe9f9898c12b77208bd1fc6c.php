<?php /*a:1:{s:58:"D:\wamp64\www\echo\application\index\view\index\index.html";i:1645449674;}*/ ?>
<!doctype html>
<html class="no-js" lang="">
    <head>
		...
		<link rel="stylesheet" type="text/css" href="/static/index/css/bootstrap.css" media="all" />
		<link rel="stylesheet" type="text/css" href="/static/index/css/font-awesome.css" media="all" />
		<link rel="stylesheet" type="text/css" href="/static/index/css/fonts.css" media="all" />

		<link rel="stylesheet" href="/static/index/css/owl.carousel.css">
		<link rel="stylesheet" href="/static/index/css/owl.theme.css">
		<link rel="stylesheet" type="text/css" href="/static/index/css/full-slider.css" media="all" />
		<link rel="stylesheet" type="text/css" href="/static/index/css/jPushMenu.css" media="all" />
		<link rel="stylesheet" type="text/css" href="/static/index/css/hover.css" media="all" />
		<link rel="stylesheet" type="text/css" href="/static/index/css/jquery.fancybox.css" media="all" />
		<link rel="stylesheet" type="text/css" href="/static/index/css/animate.css" media="all" />
		<link rel="stylesheet" type="text/css" href="/static/index/css/preload.css" media="all" />

		<link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
        <link rel="stylesheet" href="/static/index/css/normalize.css">
        <link rel="stylesheet" href="/static/index/css/main.css"><!--css for Main sayle-->
        <link rel="stylesheet" href="/static/index/css/media.css"><!--css for Responsive-->
        <script src="/static/index/js/vendor/modernizr-2.8.3.min.js"></script>
    </head>
    <body>
		...
		<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right">
			...
			<a href="index/index/login.html">Login</a>
    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
				...
				<div class="container">
					...
					<div class="row header_text">
						<div class="col-md-6 col-sm-12 col-xs-12">
							<h1>Hello, I'm <span>Echo</span><br/>
							A <span>Student</span> Of World</h1>
						</div>
            ...
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('/static/index/img/slider/slide1.jpg');"></div>
				<div class="carousel-caption overlay">
                </div>
            </div>
            <div class="item">
                <!-- Set the second background image using inline CSS below. -->
                <div class="fill" style="background-image:url('/static/index/img/slider/slide2.jpg');"></div>
				<div class="carousel-caption overlay">
                </div>
            </div>
            <div class="item">
                <!-- Set the third background image using inline CSS below. -->
                <div class="fill" style="background-image:url('/static/index/img/slider/slide3.jpg');"></div>
				<div class="carousel-caption overlay">
                </div>
            </div>
        </div>
		...
		<div class="row hireme_row">
			...
			<div class="col-md-6 col-sm-6 col-xs-12 hireme_slider  wow slideInRight">
				<div id="hireme_slide" class="owl-carousel owl-theme">
				  <div class="item"><img src="/static/index/img/slider/hire_slide1.jpg" alt="The Last of us"></div>
				  <div class="item"><img src="/static/index/img/slider/hire_slide2.jpg" alt="GTA V"></div>
				  <div class="item"><img src="/static/index/img/slider/hire_slide3.jpg" alt="Mirror Edge"></div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div id="sponsor_slide" class="owl-carousel owl-theme">
						<div class="item"><img src="/static/index/img/eivato.png" alt="" /></div>
						<div class="item"><img src="/static/index/img/jquery.png" alt="" /></div>
						<div class="item"><img src="/static/index/img/sass.png" alt="" /></div>
						<div class="item"><img src="/static/index/img/less.png" alt="" /></div>
						<div class="item"><img src="/static/index/img/jquery.png" alt="" /></div>
						<div class="item"><img src="/static/index/img/eivato.png" alt="" /></div>
						<div class="item"><img src="/static/index/img/eivato.png" alt="" /></div>
						<div class="item"><img src="/static/index/img/jquery.png" alt="" /></div>
		...
		<div class="container">	
			...
			<div class="row project_item">
				...
				<div class="col-md-4 col-sm-6 col-xs-12 single_project  wow fadeInLeft" data-wow-delay=".2s">
					<div class="work_img">
						<img src="/static/index/img/project/p1.jpg" alt="" />
				...
				<div class="col-md-4 col-sm-6 col-xs-12 single_project  wow fadeInDown" data-wow-delay=".3s">
					<div class="work_img">
						<img src="/static/index/img/project/p2.jpg" alt="" />
						<div class="project_overlay">
				...
				<div class="col-md-4 col-sm-6 col-xs-12 single_project  wow fadeInRight" data-wow-delay=".2s">
					<div class="work_img">
						<img src="/static/index/img/project/p3.jpg" alt="" />
						<div class="project_overlay">
				...
				<div class="col-md-4 col-sm-6 col-xs-12 single_project  wow fadeInLeft" data-wow-delay=".2s">
					<div class="work_img">
						<img src="/static/index/img/project/p4.jpg" alt="" />
						<div class="project_overlay">
				...
				<div class="col-md-4 col-sm-6 col-xs-12 single_project  wow fadeInUp" data-wow-delay=".3s">
					<div class="work_img">
						<img src="/static/index/img/project/p5.jpg" alt="" />
						<div class="project_overlay">
				...
				<div class="col-md-4 col-sm-6 col-xs-12 single_project  wow fadeInRight" data-wow-delay=".2s">
					<div class="work_img">
						<img src="/static/index/img/project/p6.jpg" alt="" />
						<div class="project_overlay">
	...
	<footer  class="footer_area">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<p>&copy;  2014 <a rel="nofollow" href="http://absiddik.net/demo/design/sefolio/">SEFolio</a> / Design by <a rel="nofollow" href="https://www.behance.net/siblu">Eftakher Alam</a> / Develop by <a rel="nofollow" href="http://www.absiddik.net/">A.B. Siddik</a></p>
				</div>
			</div>
		</div>
        ...
        <script src="/static/index/js/jPushMenu.js"></script>
		<script src="/static/index/js/owl.carousel.js"></script>
		<script src="/static/index/js/jquery.fancybox.js"></script>
		<script src="/static/index/js/jquery.fancybox.pack.js"></script>
